...
_BASE_LANE_OFFSETS: dict[FlowKey, tuple[LaneOffset, LaneOffset]] = {
    ...
    (-1, 0, 1, 0): ((19, 10), (1, 10)),
    (1, 0, -1, 0): ((1, 10), (19, 10)),
    # Corners (screen x grows right, y grows down)
    (-1, 0, 0, 1): ((19, 1), (1, 19)),
    (0, 1, 1, 0): ((19, 19), (1, 1)),
    (1, 0, 0, -1): ((1, 19), (19, 1)),
    (0, -1, -1, 0): ((1, 1), (19, 19)),
...
_DERIVED_LANE_OFFSETS: dict[FlowKey, tuple[LaneOffset, LaneOffset]] = {
    (-1, 0, 0, -1): _derive_mirrored_lane_offsets((-1, 0, 0, 1), mirror_x=True),
    (0, -1, 1, 0): _derive_mirrored_lane_offsets((0, -1, -1, 0), mirror_y=True),
    (0, 1, -1, 0): _derive_mirrored_lane_offsets((0, 1, 1, 0), mirror_y=True),
    (1, 0, 0, 1): _derive_mirrored_lane_offsets((1, 0, 0, -1), mirror_x=True),
}
